...
/*fn main() {
   /* println!("Hello, world!");
    ...
    // {} will automatically replaced with an arguments in general, it will be stringified
    println!( "{} days" , 31);
    //positional argument can be used . pointing an interger inside {}
    //determines which additional arugment will be replaced .
    // argpument start at {0} and then goes on
...
fn main (){
   ...
   let sex = "male";
   let  height = 5.6;
   let emmanuel = Person { name, age, sex, height };
   println!("{:#?}", emmanuel);
}  */
...
impl fmt::Display for Checking {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "x: {}, y: {}, z: {}, a: {}", self.x, self.y, self.z, self.a)
    }
}
...
fn main() {
    ...
    let checking = Checking { x: 5.0, y: 3.0, z: 3.0, a: 4.0 };
   println!("Compare checking:");
   println!("Display: {}", checking);
...
//import std::fmt; // Import the `fmt` module.
/*use std::fmt; 
struct List(Vec<i32>);
...
fn main(){
    ...
    println!( "hi i am  {}, i am {} years old, i am a {} and my height is {} feet", peter.name, peter.age, peter.sex, peter.height);
} */
...
fn main () {
    ...
    println!("the area of the rectangle is {}", rectangle.width * rectangle.height);
}
...
fn main(){
    ...
    let name= String::from("sunday");
    let age=  23;
    let place_of_birth = String::from("lagos");
    let sunday =Person { name, age, place_of_birth };
    println!("{:?}", sunday);

    let  rectangle = Rectangle { width: 30, height: 50 };

    fn rect_area(rectangle: Rectangle) -> u64 {
        (rectangle.width * rectangle.height) as u64
    }
...
fn main(){
    ...
    println!("The sum of {} and {} is {}", x, y, VeryVerboseEnumOfThingsToDoWithNumbers::Add.run(x, y));
    println!("The difference of {} and {} is {}", x, y, VeryVerboseEnumOfThingsToDoWithNumbers::Subtract.run(x, y));
}
*/
/*#[derive(Debug)]
enum Stage {
...
fn main(){
    ...
    let roles =[Teacher, Student, Admini, Secturity];
    for role in roles {
        match role {
            Teacher => println!("teacher role"),
            Student => println!("student role"),
            Admini => println!("admini role"),
            Security => println!("security role"),
        }
    }
    ...
    match stage{
        ...
        Intermediate => println!("intermediate stage"),
        Advanced => println!("advanced stage"),
    }
}
} */
...
fn main(){
    ...
    let roles = [Teacher,Student,Tailor,Parent];
    for role in roles {

        println!("this are the {:?}'s available
    ", role);
    match role {
        Teacher => println!(" teaches your children"),
        Student => println!(" must learn from"),
       Tailor => println!(" must learn from"),
        Parent => println!(" must learn from"),
...
let arithmic =[Add,Subtract];
for Arithmic in arithmic{
    let x = 5;
    let y= 4;
    let other_Add: u64 = x + y ;
    let other_Subtract: u64= x - y;}

    println!(" the addition of numbers {:?}", Arithmic::Add)
...
s1.push_str("emmanuel");
println!("{}", s1);

}  
fn main(){
    let mut e = String::from("hello");
    e.push_str(" fada is home");
    println!("{}", e);
...
fn main (){
    ...
    println!(" bring the value of  {:?} up when you see this", num)
} 
...
/* fn main (){
    ...
    let big_n = 
    if n < 10 && n > -10 {
        println! (", and is a small number, increse ten -folds");
        10 * n 
    }else  { 
...
*
fn main() {
    let name= vec![ "fada", "thhank", "ferries"];

    for name in name.iter() {
        match name {
            &"fada" => println!(" i love me"),
           _ => println!("Hello {}", name ),
        }
    }
    println!("name: {:?}", name)
...
fn main(){
    ...
    println!("Tell me more about number{}", number);

     match number {
        1 => println!("Tell  me more about {}", number),
        2 | 3 | 5 | 7 | 11 => println!("This is a primes"),
        13..=19 => println!("Ain't special"),
...
fn main() {
    ...
    //println!("is an adlut? {}" , age::is_adult);
}
*
fn main() {
    ...
    {
        let borrow2 =&i ;
        println!("borrow2  ends here: {}", borrow2);
...
fn give_me_drink(drink: Option<&str>){
    match drink{
  Some("lemonade") => println!("Yuck! Too sugary."),
Some(inner) => println!("some inner, How nice"),
None => println!("we got nothing lol"),
    }
}

fn drink(drink: Option<&str>){
    let inside = drink.unwrap();
    if inside == "lemonade" { panic!("WE aint drinking this");}
...
fn vec_loop(input: &[i32]) -> Vec<i32> {
    ...
    for element in input {
        ...
        // the `output` vector.
        let _ = ((input.0 * input.1 * input.2 *input.3).abs()) / 2;
        input::output;
    }
...
fn generate_nametag_text(name: String) -> Result<String,String> {
    if name.is_empty() {
       ...
       Err(String::from("Empty names arent allowed"))
    } else {
...
fn compare_license_types(software1: Licensed, software2: Licensed) -> bool {
...
mod tests {
    ...
    fn iterators() {
        ...
        assert_eq!(fav_fruits_iterator.next(), Some(None)); // TODO: Replace `todo!()`
    }
}*
use std::char;
...
fn capitalize_words_vector(words: &[&str]) -> String {
    
    let mut chars =input.chars();
    match chars.next(){
        None => String::new(),
    Some(first) => first.to_uppercase().to_string() + char.as_str()
}}
...
fn main() {
    ...
    println!("Jobs done: {}", status.lock().unwarp().jobs_done);
}*
